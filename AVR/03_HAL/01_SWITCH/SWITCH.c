 ...
 SWITCH_enuErorState SWITCH_enuGetSwitchState(u8 Copy_u8SwitchName , u8 *Add_u8State)
	{
		...
		{
			 Loc_DioErorsState = DIO_enuGetPinLogic(SWITCHS_Arr[NUM_OF_SWITCHS].SWITCH_StrU8PortCfg , SWITCHS_Arr[NUM_OF_SWITCHS].SWITCH_StrU8PinCFg ,&Loc_u8State);
		     switch(SWITCHS_Arr[NUM_OF_SWITCHS].SWITCH_StrU8SWITCHState)
		       {
			        case (SWITCH_PULLUP):
