...
#define INT0_SENSE_CTRL      INT0_FALLING_EDGE   /* Options: INT0_LOW_LEV, INT0_ANY_EDGE, INT0_FALLING_EDGE, INT0_RISING_EDGE */

/* Macros for INT1 */
#define INT1_MODE            EXTI_ENABLE          /* Options: EXTI_ENABLE, EXTI_DISABLE */
#define INT1_SENSE_CTRL      INT1_RISING_EDGE    /* Options: INT1_LOW_LEV, INT1_ANY_EDGE, INT1_FALLING_EDGE, INT1_RISING_EDGE */
